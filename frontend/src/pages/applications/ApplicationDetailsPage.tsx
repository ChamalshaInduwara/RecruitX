...
function ApplicationDetailsPage() {
  ...
  const [
    ...
    useState<ApplicationDetails | null>(
      null
    );
  ...
  const handleCompleteInterview =
    async (
      ...
      try {
        ...
        await api.patch(
          `/interviews/${interviewToComplete}/complete`,
          {
            feedback:
              interviewFeedback.trim(),
          }
